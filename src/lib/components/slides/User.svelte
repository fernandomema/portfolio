...
<Slide class={`bg-blue-400 ${className ?? ''}`} {floating}>
    {#snippet content()}
        <div class="w-full h-full flex justify-center items-center p-4 sm:p-8">
            <div class="relative w-full h-full flex justify-center items-center overflow-hidden">
                ...
                >
                    ...
                    <div class="flex flex-col gap-4 text-center sm:text-left justify-center">
                        ...
                        >
                            <span class="icon-[tabler--info-circle] size-5 transition-transform group-hover:rotate-12"></span>
                ...
                >
                    <div class="flex justify-between items-start mb-6">
                        ...
                        <button
                            ...
                            aria-label="Cerrar"
                        >
                            <span class="icon-[tabler--x] size-6 hover:rotate-90 transition-transform inline-block"></span>
                        </button>
                    </div>
